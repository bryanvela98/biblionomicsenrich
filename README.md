...
The backend is deployed using AWS SAM, which uses CloudFormation under the hood. All AWS resource definitions are in `backend/template.yaml`. The codebase is at https://github.com/bryanvela98/biblionomicsenrich.
...
The current `dev` deployment is available at: **https://d3ua9vjlayau27.cloudfront.net**
